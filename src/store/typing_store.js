...
import { Emitter } from '../algorithm/flux.js';
import { KeyEvent } from '../core/keyboard/key_event.js';
import StrokeState from '../core/stroke/stroke_state.js';
import StrokeTable from '../core/stroke/stroke_table.js';
import { Vocabularies, Vocabulary } from '../model/vocabulary.js';
import KeyboardMapsConfig from '../conf/keyboard_map.js';

const googleImeStrokeTable = `
-	ー
,	、
;-	〜
;[	『
...
export default class TypingStore extends Emitter {
  ...
  reset() {
    ...
    this.strokeState = new StrokeState(StrokeTable.fromString(googleImeStrokeTable));
  }
  ...
  start() {
    this.vocabularies = new Vocabularies([
      Vocabulary.createKana('俺の妹がこんなに可愛いわけがない', 'おれのいもうとがこんなにかわいいわけがない'),
